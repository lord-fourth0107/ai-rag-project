...
class InstructDatasetSample(BaseVectorDocument):
    instruction: str
    answer: str
...
class PreferenceDatasetSample(BaseVectorDocument):
    instruction: str
    rejected: str
    chosen: str
...
class InstructDataset(BaseVectorDocument):
...
class TrainTestSplit(BaseVectorDocument):
    train: dict
    test: dict
...
class PreferenceDataset(BaseVectorDocument):
    category: DataCategory
