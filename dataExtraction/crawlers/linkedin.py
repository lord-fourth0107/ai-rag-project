...
from models.documentModels import PostDocument
#from llm_engineering.domain.exceptions import ImproperlyConfigured
#from settings import settings
LINKEDIN_USERNAME = None #settings.LINKEDIN_USERNAME
LINKEDIN_PASSWORD = None #settings.LINKEDIN_PASSWORD
...
class LinkedInCrawler(BaseSeleniumCrawler):
    ...
    def extract(self, link: str, **kwargs) -> None:
        ...
        self.model.bulk_insert(
            [
                PostDocument(platform="linkedin", content=post)
                for post in posts
            ]
        )
